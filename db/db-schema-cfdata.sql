...
CREATE TABLE `tblcollections` (
  ...
  CONSTRAINT `userId` FOREIGN KEY (`userId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `tblcomments` (
  ...
  CONSTRAINT `authorId` FOREIGN KEY (`userId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
CREATE TABLE `tblgroupusers` (
  ...
  CONSTRAINT `memberId` FOREIGN KEY (`userId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `tblmessages` (
  ...
  CONSTRAINT `receiverId` FOREIGN KEY (`receiverId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION
...
CREATE TABLE `tbluserdevices` (
  ...
  CONSTRAINT `deviceUserId` FOREIGN KEY (`userId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tblvotes` (
  ...
  CONSTRAINT `voteUserId` FOREIGN KEY (`userId`) REFERENCES `tblusers` (`userId`) ON DELETE CASCADE ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-03-19  7:14:11
